  ...
  'Executive Council': [
    {
      title: 'President',
      candidates: [
        { name: 'Maria Santos', votes: 312 },
        { name: 'Jose Reyes', votes: 278 },
        { name: 'Ana Dela Cruz', votes: 195 },
      ],
    },
    {
      title: 'Vice President',
      candidates: [
        { name: 'Carlo Mendoza', votes: 401 },
        { name: 'Liza Bautista', votes: 334 },
        { name: 'Mark Villanueva', votes: 210 },
      ],
    },
    {
      title: 'Secretary',
      candidates: [
        { name: 'Sofia Torres', votes: 445 },
        { name: 'Ryan Flores', votes: 389 },
      ],
    },
    {
      title: 'Treasurer',
      candidates: [
        { name: 'Patricia Gomez', votes: 420 },
        { name: 'Daniel Aquino', votes: 365 },
        { name: 'Camille Navarro', votes: 150 },
      ],
    },
  ],
  CITE: [
    {
      title: 'President',
      candidates: [
        { name: 'Kevin Tan', votes: 88 },
        { name: 'Rachel Uy', votes: 74 },
        { name: 'James Co', votes: 52 },
      ],
    },
    {
      title: 'Vice President',
      candidates: [
        { name: 'Nicole Sy', votes: 101 },
        { name: 'Brian Lim', votes: 89 },
      ],
    },
    {
      title: 'Secretary',
      candidates: [
        { name: 'Trisha Wong', votes: 95 },
        { name: 'Andrei Cruz', votes: 88 },
        { name: 'Mia Dizon', votes: 31 },
      ],
    },
    {
      title: 'Treasurer',
      candidates: [
        { name: 'Luis Chua', votes: 110 },
        { name: 'Vanessa Ong', votes: 84 },
      ],
    },
  ],
  CBEAM: [
    {
      title: 'President',
      candidates: [
        { name: 'Ella Ramos', votes: 67 },
        { name: 'Marco Yap', votes: 55 },
        { name: 'Jana Roxas', votes: 40 },
      ],
    },
    {
      title: 'Vice President',
      candidates: [
        { name: 'Dino Pascual', votes: 72 },
        { name: 'Sheena Alba', votes: 61 },
      ],
    },
    {
      title: 'Secretary',
      candidates: [
        { name: 'Kristine Delos Reyes', votes: 80 },
        { name: 'Paolo Serrano', votes: 58 },
      ],
    },
    {
      title: 'Treasurer',
      candidates: [
        { name: 'Bianca Hilario', votes: 77 },
        { name: 'Enrique Magno', votes: 65 },
        { name: 'Lourdes Perez', votes: 20 },
      ],
    },
  ],
  CON: [
    {
      title: 'President',
      candidates: [
        { name: 'Grace Dimaculangan', votes: 54 },
        { name: 'Harold Vizcaya', votes: 47 },
      ],
    },
    {
      title: 'Vice President',
      candidates: [
        { name: 'Ivy Tolentino', votes: 60 },
        { name: 'Renz Malabanan', votes: 41 },
      ],
    },
    {
      title: 'Secretary',
      candidates: [
        { name: 'Abby Castillo', votes: 55 },
        { name: 'Noel Soriano', votes: 46 },
      ],
    },
    {
      title: 'Treasurer',
      candidates: [
        { name: 'Fiona Alcantara', votes: 63 },
        { name: 'Gerald Estrada', votes: 38 },
      ],
    },
  ],
  CEAS: [
    {
      title: 'President',
      candidates: [
        { name: 'Diana Mercado', votes: 92 },
        { name: 'Eric Bondoc', votes: 76 },
        { name: 'Lyra Manalo', votes: 44 },
      ],
    },
    {
      title: 'Vice President',
      candidates: [
        { name: 'Felix Hernandez', votes: 99 },
        { name: 'Gina Macapagal', votes: 83 },
      ],
    },
    {
      title: 'Secretary',
      candidates: [
        { name: 'Hannah Espinosa', votes: 105 },
        { name: 'Ivan Lorenzo', votes: 79 },
        { name: 'Jasmine Padilla', votes: 28 },
      ],
    },
    {
      title: 'Treasurer',
      candidates: [
        { name: 'Kenneth Reyes', votes: 88 },
        { name: 'Lorraine Salazar', votes: 73 },
      ],
    },
  ],
  CIHTM: [
    {
      title: 'President',
      candidates: [
        { name: 'Mara Dalisay', votes: 45 },
        { name: 'Nathan Evangelista', votes: 38 },
      ],
    },
    {
      title: 'Vice President',
      candidates: [
        { name: 'Olivia Francisco', votes: 50 },
        { name: 'Patrick Guerrero', votes: 33 },
      ],
    },
    {
      title: 'Secretary',
      candidates: [
        { name: 'Queen Ignacio', votes: 47 },
        { name: 'Robert Jacinto', votes: 36 },
      ],
    },
    {
      title: 'Treasurer',
      candidates: [
        { name: 'Stella Katipunan', votes: 52 },
        { name: 'Timothy Lacson', votes: 31 },
      ],
    },
  ],
};
...
function getDataForTab(tab: string): { college: string; positions: Position[] }[] {
  if (tab === 'All') {
    return Object.entries(RAW_DATA).map(([college, positions]) => ({ college, positions }));
  }
  if (RAW_DATA[tab]) {
    return [{ college: tab, positions: RAW_DATA[tab] }];
  }
  return [];
}
      ...
      <View style={styles.barTrack}>
        <View
          style={[
            ...
            {
              width: `${pct}%`,
              backgroundColor: isLeading ? accentColor : accentColor + '66',
            },
          ]}
        />
...
function CollegeSection({
  ...
  return (
    <View style={styles.collegeSection}>
      ...
      {positions.map((pos) => (
        <PositionCard key={pos.title} position={pos} accentColor={color} />
      ))}
    </View>
  );
}
    ...
    <SafeAreaView style={styles.safe}>
      ...
      >
        {sections.map(({ college, positions }) => (
          <CollegeSection key={college} college={college} positions={positions} />
        ))}
